...
namespace ClassSample
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(persona1._id);
            Console.WriteLine(persona1._name);
            Console.WriteLine(persona1._departamento);

            Documento documento = new Documento("Boleta", "B01-001", 239.75);
            Console.WriteLine(documento._tipo);
            Console.WriteLine(documento._correlativo);
            Console.WriteLine(documento._valor);
        }
    }
}
